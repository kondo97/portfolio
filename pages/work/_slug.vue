<template>
  <div class="bg-gray-100 text-black pb-10">
    <div 
      class="w-full h-80 my-6 bg-cover bg-center shadow-lg"
    ...
    <h1 class="text-center text-4xl mt-6">{{ work.fields.title }}</h1>
    <p class="text-center text-sm mt-3">{{ work.fields.subtitle }}</p>
    <div class="flex justify-center mb-5">
      <li 
        v-for="tag in work.fields.tag"
        :key="tag.sys.id"
        class="list-none text-xs m-1 bg-gray-300 p-1 rounded mt-3 text-black pointer"
